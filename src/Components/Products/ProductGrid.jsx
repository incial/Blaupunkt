  ...
  <>
    ...
    <div className="mb-6 text-center">
      <p className="text-blaupunkt-dark font-myriad text-sm">
        Showing {Math.min(indexOfFirstProduct + 1, sortedProducts.length)}-{Math.min(indexOfLastProduct, sortedProducts.length)} of {sortedProducts.length} products
        {searchQuery && (
    ...
    {products.length > 0 ? (      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12">
